...
function cmanOM_JS_mmove(e){
	...
	if (cmanOM_VAR['device'] == 'mobi') {
	    ...
	    home_pos = cmanOM_VAR['objNowImg'].style.left;
	}else{
    ...
    // 画像入れ替え表示処理
	    if ( home_pos < cmanOM_VAR['objNowImg'].style.left ) {
	        if (left_img == 1 ) {
	            document.getElementById("anime_img").src = './images/mario_2.png';
	            left_img = 2;
	        } else if (left_img == 2)  {
	            document.getElementById("anime_img").src = './images/mario_3.png';
	            left_img = 3;
	        } else {
	            document.getElementById("anime_img").src = './images/mario_1.png';
	            left_img = 1;
	        }
	        
	    } else if ( home_pos > cmanOM_VAR['objNowImg'].style.left ) {
	        if (right_img == 4 ) {
	            document.getElementById("anime_img").src = './images/mario_5.png';
	            right_img = 5;
	        } else if (left_img == 5)  {
	            document.getElementById("anime_img").src = './images/mario_6.png';
	            left_img = 6;
	        } else {
	            document.getElementById("anime_img").src = './images/mario_4.png';
	            right_img = 4;
	        }
	    }
	    home_pos = cmanOM_VAR['objNowImg'].style.left;
